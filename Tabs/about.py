...
def about_page():
    ...
    # Page Title
    st.markdown("<h1 style='color: black;'>About This Project</h1>", unsafe_allow_html=True)

    col_logo, col_logo1, col_logo2 = st.columns([1, 1, 5])
    with col_logo1:
        st.image("images/logo-rvce.png", use_container_width=True, caption="RV College of Engineering")  
    with col_logo2:
        st.image("images/coe.png", width=600, caption="Computational Genomics Centre of Excellence")  

    # Side-by-side layout for sections
    col1, col2 = st.columns(2)
    with col1:
        st.markdown("<h2 style='color: black;'>Data Collection</h2>", unsafe_allow_html=True)
        st.markdown(
            '<div class="info-box">'
            "<p style='color: black;'>The dataset used in this project was collected by:<br>"
    ...
    with col2:
        st.markdown("<h2 style='color: black;'>Webpage Development</h2>", unsafe_allow_html=True)
        st.markdown(
            '<div class="info-box">'
            "<p style='color: black;'>This webpage was designed and developed by:<br>"
